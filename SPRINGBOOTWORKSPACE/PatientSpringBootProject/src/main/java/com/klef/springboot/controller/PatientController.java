	 ...
	 @GetMapping("/")
	    ...
	    public ResponseEntity<String> deletePatient(@PathVariable int id) {
	        ...
	        if (existing != null) {
	            ...
	            return new ResponseEntity<>("Patient" + id + " deleted successfully.", HttpStatus.OK);
	        } else {
	            return new ResponseEntity<>("Cannot delete. Patient " + id + " not found.", HttpStatus.NOT_FOUND);
	        }
	    }
